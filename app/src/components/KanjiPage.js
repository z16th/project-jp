  ...
  return (
    <>
      ...
      <p>
        ...
        Chinos, llamados <strong>kanji</strong>. La mayoría de los kanji son
        ideogramas (símbolos que representan un concepto abstracto, como
        &quot;arriba&quot; 上 ), pictogramas (bosquejos del objeto que
        representan, por ejemplo &quot;árbol&quot; 木 ) o una combinación de
        ambos (por ejemplo, 峠 que significa paso de montaña y es una
        combinación de 山 &quot;montaña&quot;, 上 &quot;arriba&quot; y 下
        &quot;abajo&quot;).
      </p>
      <h3>Los radicales</h3>
      <p>
        Los kanji están compuestos de una serie de trazos predefinidos, llamados
        <strong>radicales.</strong> Ya que casi todos los kanji son una
        combinación de dos o más radicales, es útil aprenderlos.
      </p>
      <h3>Las pronunciaciones</h3>
      <p>
        Hay dos formas básicas en las que los kanjis pueden ser leídos: la
        pronuncación <strong>on-yomi</strong> o China, y la pronunciación
        <strong>kun-yomi</strong> o Japonesa. Antes de que los Japoneses tomaran
        prestado el sistema de escritura China, no existía un lenguaje escrito
        en Japón.
      </p>
      <h2>Uso</h2>
      <p>
        Los kanji pueden aparecer solos, pero es más común que aparezcan en
        grupos de dos o más kanji, o junto a terminaciones en hiragana. Existen
        2,136 kanjis de &quot;uso regular&quot; los cuales son combinados para
        crear las decenas de miles de palabras del idioma Japonés. Gran parte de
        estos caracteres provienen del Chino. Algunos de ellos fueron inventados
        en Japón, y adoptados en China. A diferencia del Chino, los kanji
        Japoneses usualmente tienen más de una pronuncación, la cual depende del
      ...
      <section className="flex-center">
        <ul>
          ...
          <li>
            Cuando una línea horizontal y una vertical se cruzan, la horizontal
            se dibuja primero.
          </li>
          <li>
      ...
      <section className="flex-center">
        <ul>
          ...
          <li>
            Pictogramas compuestos (varios pictogramas que forman uno solo)　森,
            町, 物
          </li>
          <li>
            Ideogramas de sonido (una combinación de caracteres usados por su
            sonido y otros caracteres usados por su significado)　英, 語, 曜
          </li>
        </ul>
      </section>
      <p>
        Aproximadamente el 90% de los kanjis son ideogramas de sonido
        compuestos.
      </p>
    </>
  )
